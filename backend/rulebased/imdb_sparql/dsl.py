...
HasKeyword.relation = "dbpprop:name"
#HasKeyword.language = "en"

class IsPerson(FixedType):
    #fixedtype = "foaf:Person"
    fixedtype = "dbpedia-owl:Person"

class IsActor(FixedType):
    fixedtype = "dbpedia-owl:Actor"

class IsDirector(FixedType):
    fixedtype = "dbpedia-owl:MovieDirector"
...
class MovieGenreOf(FixedRelation):
    relation = "dbpedia-owl:genre"
    reverse = True

class IsGenre(FixedType):
    fixedtype = "dbpedia-owl:genre"
...
class FollowedBy(FixedRelation):
    relation = "dbpprop:follows"
    reverse = True

class Follows(FixedRelation):
    relation = "dbpprop:follows"
...
class IsKeyword(FixedType):
    fixedtype = "dbpedia-owl:projectKeyword"


class PlotOf(FixedRelation):
    relation = "dbpprop:plot"
    reverse = True

class CounterOf(FixedDataRelation):
    relation = "dbpprop:counter"
    reverse = False
